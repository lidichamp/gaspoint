...
storeLocator.Panel = function(el, opt_options) {
  ...
  this.settings_ = $.extend({
      'locationSearch': true,
      'locationSearchLabel': 'where would you like your gas to be  delivered?',
      'featureFilter': true,
      'directions': true,
      'view': null
    }, opt_options);
...
storeLocator.Panel.NO_STORES_HTML_ = '<li class="no-stores">There are no' +
    ' gaspoint agents in this area.</li>';
...
storeLocator.Panel.NO_STORES_IN_VIEW_HTML_ = '<li class="no-stores">There are' +
    ' no gaspoint agents in this area. However, the agents closest to you are' +
    ' listed below.</li>';
/**
