            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="/admin/home"><i class="ion ion-bag"></i>View Orders</a></li>

                    </ul>
                    <ul class=" treeview-menu">
                        <li><a href="/admin/manage/agents"><i class="ion ion-person-add"></i>View Agents</a></li>
                    </ul>

                    <ul class=" treeview-menu">
                        <li class="active"><a href="#"><i class="fa fa-home"></i>View Depots</a></li>
                    </ul>
                </li>
            </ul>
    </aside>
                ...
                <section class="col-lg-10 connectedSortable">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <ul class="nav nav-tabs pull-right">
                            ...
                            <li class="pull-left header"><i class="fa fa-inbox"></i> Stores</li>
                        </ul>
