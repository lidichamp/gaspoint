...
<head>
  ...
  <title>Gaspoint | ControlPanel</title>
...
<div class="wrapper">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <b> {{$user->name}}</b> <br> Agent
                  <small>Agent since {{$user->created_at->diffForHumans()}}</small>
                </p><br>
              </li>
              <!-- Menu Body -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="#"><i class="ion ion-bag"></i>View Orders</a></li>

          </ul>
        <ul class=" treeview-menu">
        <li><a href="/admin/manage/agents"><i class="ion ion-person-add"></i>Approve Agent</a></li>
        </ul>

          <ul class=" treeview-menu">
            <li><a href="/admin/manage/depots"><i class="fa fa-home"></i>View Depots</a></li>
          </ul>
        </li>
      </ul>
  </aside>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3>{{\App\Order::where('status','complete')->count()}}</h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3>{{\App\Order::where('status','cancelled')->count()}}</h3>
        ...
        <section class="col-lg-10 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content no-padding">
              ...
              <div class="chart tab-pane" id="sales-chart" style="position: relative; height: 400px;">  {!! $chart->html() !!}</div>
            </div>
          </div>
          <!-- /.nav-tabs-custom -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="https://Gaspoint.com">Gaspoint</a>.</strong> All rights
    reserved.
  </footer>
