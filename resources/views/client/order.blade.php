      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
    <form role="form" method="POST" action="{{ url('/orders/save') }}">
                        {{ csrf_field() }}
                <!-- text input -->
                ...
                <div class="form-group">
                  <label>Gas quantity in kg:</label>
                  <input type="number" name="quantity" class="form-control" placeholder="12" required>
                </div>
                <!-- textarea -->
                <div class="form-group">
                  <label>Special Requests:</label>
                  <textarea class="form-control" name="others" rows="3" placeholder="SPECIAL DETAILS"></textarea>
                </div>            <!-- /.box-footer -->
                <input type="hidden" name="agent_id" value="{{ app('request')->route('id') }}"> 
