...
<div class="register-box">
    ...
    <div class="register-box-body">
        <p class="login-box-msg">Register as an Agent</p>

        <form class="form-horizontal" role="form" method="POST" action="{{ url('/fieldagent/register') }}">
            {{ csrf_field() }}
            ...
            <div class="form-group has-feedback">
                <input id="phone" type="numeric" class="form-control" name="phone" value="Phone Number">
